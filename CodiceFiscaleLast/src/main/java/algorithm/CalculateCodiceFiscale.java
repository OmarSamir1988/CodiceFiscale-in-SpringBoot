...
import static algorithm.FunctionChecks.howManyConsonants;
import static algorithm.FunctionChecks.isAllLetters;
import static algorithm.FunctionChecks.isDateValid;
import static algorithm.FunctionChecks.isYearValid;
import static algorithm.FunctionChecks.replaceSpecialChars;
import static algorithm.NameAndSurnameComputations.pickFirstConsonantAndFirstTwoVowels;
import static algorithm.NameAndSurnameComputations.pickFirstThirdAndFourthConsonant;
import static algorithm.NameAndSurnameComputations.pickFirstThreeConsonants;
import static algorithm.NameAndSurnameComputations.pickFirstThreeVowels;
import static algorithm.NameAndSurnameComputations.pickFirstTwoConsonantsAndFirstVowel;
...
@Service
public class CalculateCodiceFiscale {
    ...
    public static String computeTownOfBirth(String townString) throws IOException {
        ...
        try (BufferedReader read =
                     new BufferedReader(
                             new InputStreamReader(CalculateCodiceFiscale.class.getResourceAsStream("/TownCodeList.txt")))) {
